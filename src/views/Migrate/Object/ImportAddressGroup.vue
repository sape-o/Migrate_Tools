<template>
  <div class="full-card">
    <button class="import-btn" @click="triggerFileUpload">Import Address Group</button>
...
async function fetchObjects(type = 'addressgroup') {
...
async function handleFileUpload(event) {
  ...
  try {
    ...
    // อัพเดตรายการใหม่หลัง upload เสร็จ
    fetchObjects()
  } catch (err) {
    console.error(err)
    alert('Upload failed')
...
// ฟังก์ชันช่วยแปลงวันที่ให้อ่านง่ายขึ้น
