...
<template>
    ...
    >
      <template #header>
        <div class="flex justify-between">
          <Button label="Add User" style="width: auto" @click="openAdd" />
          <IconField>
            <InputIcon>
      ...
      <Column header="Action" style="min-width: 10rem" bodyClass="text-center">
        <template #body="{ data }">
          <Button icon="pi pi-pencil" class="mr-2" text @click="openEdit(data)" />
  ...
  <Dialog :header="isEditMode ? 'Edit User' : 'Add User'" v-model:visible="display" :breakpoints="{ '960px': '75vw' }" :style="{ width: '50vw' }" :modal="true">
